...
export default function ServiceList() {
  ...
  const services = [
    ...
    {
      "title": "Brackets",
      "desc": ["- Brackets Metálicos de acero inoxidable de color gris plata. Clásicos y económicos.", " ", "- Brackets de Porcelana de color blanco siendo más delicados y discretos.", " ", "- Brackets de Zirconio que son altamente estéticos, de aspecto cristal."],
